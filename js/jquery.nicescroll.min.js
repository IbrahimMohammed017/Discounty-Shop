  ...
  function l(e, o) {
    ...
    if (
      ...
      "horizontal-tb" == i || "lr-tb" == i || "" === i
        ...
        : ((this.isrtlmode =
          ...
          (this.isvertical = "vertical-rl" == i || "tb" == i || "tb-rl" == i));
    ...
    (this.getDocumentScrollOffset = function () {
      ...
      (this.updateScrollBar = function (e) {
        ...
        if (b.ishwscroll)
          b.rail.css({
            height:
              b.win.innerHeight() - (x.railpadding.top + x.railpadding.bottom),
          }),
            b.railh &&
              b.railh.css({
                width:
        ...
        if (
          ...
          if (
            ...
            (b.ontouchstart = function (e) {
              ...
              if (
                ((b.hasmoving = !1),
                b.scrollmom.timer && (b.triggerScrollEnd(), b.scrollmom.stop()),
                !b.railslocked)
              ) {
                var o = b.getTarget(e);
                if (o)
                ...
                (b.railh &&
                  ...
                  b.ishwscroll && x.bouncescroll
                    ? d < 0
                      ? (d = Math.round(d / 2))
                      : d > b.page.maxw &&
                        (d = b.page.maxw + Math.round((d - b.page.maxw) / 2))
                    : (d < 0 && (l = d = 0),
                      d > b.page.maxw && ((d = b.page.maxw), (l = 0)))),
                !b.hasmoving)
              ) {
                if (b.rail.drag.y === e.clientY && b.rail.drag.x === e.clientX)
                  return b.cancelEvent(e);
                var u = Math.abs(n),
                  h = Math.abs(a),
              ...
              (b.ontouchmoveCursor = function (e) {
                if (b.rail.drag) {
                  ...
                  if (((b.cursorfreezed = !0), b.rail.drag.hr)) {
                    (b.scroll.x =
                      b.rail.drag.sx + (e.touches[0].clientX - b.rail.drag.x)),
                      b.scroll.x < 0 && (b.scroll.x = 0);
                    var o = b.scrollvaluemaxw;
                    b.scroll.x > o && (b.scroll.x = o);
                  } else {
                    (b.scroll.y =
                      b.rail.drag.sy + (e.touches[0].clientY - b.rail.drag.y)),
          ...
          if (
                ...
                return (
                  b.synched("mousemove", function () {
                    b.cursorfreezed &&
                      (b.showCursor(),
                      b.rail.drag.hr
                        ? b.scrollLeft(Math.round(b.scroll.x * b.scrollratio.x))
                        : b.scrollTop(
                            Math.round(b.scroll.y * b.scrollratio.y)
                          ));
                  }),
            ...
            (b.onpreventclick = function (e) {
              ...
              x.grabcursorenabled &&
                S.cursorgrabvalue &&
                (b.css(b.ispage ? b.doc : b.win, { cursor: S.cursorgrabvalue }),
          ...
          if (
            ...
            b.ispage ||
              ...
              b.bind(b.win, "mouseenter", function (e) {
                (M = b.getTarget(e).id || b.getTarget(e) || !1),
                  (b.hasmousefocus = !0),
                  b.canshowonmouseevent && b.noticeCursor();
              }),
            ...
            (b.onkeypress = function (e) {
              ...
              if (
                ...
                switch (t) {
                  ...
                  case 63232:
                    b.railh &&
                      (r ? b.doScrollLeft(0) : b.doScrollLeftBy(72), (s = !0));
                    break;
                  case 39:
                  case 63234:
                    b.railh &&
                      (r ? b.doScrollLeft(b.page.maxw) : b.doScrollLeftBy(-72),
                      (s = !0));
                    break;
                  case 33:
                  case 63276:
        ...
        if ("IFRAME" == this.doc[0].nodeName) {
          var w = function () {
            ...
            b.lazyResize(30),
              ...
              S.isios &&
                b.haswrapper &&
                b.css(P(o.body), { "-webkit-transform": "translate3d(0,0,0)" }),
        ...
        return (
          ...
          b.railslocked
            ...
            : (b.hidden ||
              ...
              b.railh &&
                ((b.railh.width = 0 < b.page.maxh ? b.rail.width : b.view.w),
                (b.scrollvaluemaxw =
                  b.railh.width -
                  b.cursorwidth -
                  (x.railpadding.left + x.railpadding.right))),
    ...
    var h = !(this.mousewheel = function (e, o, t) {
      ...
      if ("onwheel" in R.createElement("div")) b._bind(r, "wheel", o, t || !1);
        ...
        u(r, i, o, t || !1),
          "DOMMouseScroll" == i && u(r, "MozMousePixelScroll", o, t || !1);
      }
    });
    ...
    function k(e, o, t) {
      ...
      if ((b.isrtlmode && (r = -r), !w(r, i, t, !0)))
        return (z = !1), e.stopImmediatePropagation(), e.preventDefault();
      t && (z = !0);
    }
    if (
      ...
      if (
        ...
        (this.resetTransition = function () {
          ...
          (this.prepareTransition = function (e, o) {
            ...
            return (
              T !== r &&
                ((T = r), b.doc.css(S.prefixstyle + "transition-duration", r)),
              t
            );
          }),
          ...
          (this.doScrollPos = function (e, o, t) {
            ...
            b.scrollrunning ||
              ...
              S.transitionend ||
                ...
                (b.scrollendtrapped = setTimeout(b.onScrollTransitionEnd, c))),
        ...
        b.rail.drag ||
          ...
          b.synched("scroll", function () {
            (b.scroll.y = Math.round(b.getScrollTop() / b.scrollratio.y)),
              b.railh &&
                (b.scroll.x = Math.round(b.getScrollLeft() / b.scrollratio.x)),
              b.noticeCursor();
          });
      }),
